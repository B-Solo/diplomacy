...
QTabBar::tab { background: transparent; padding: 6px 12px; border-bottom: 2px solid transparent; font-weight: 600; }
...
QPlainTextEdit, QTextEdit, QLineEdit, QListWidget, QTableWidget, QTreeWidget { background: #fffdf7; border: 1px solid #aaa18e; border-radius: 2px; selection-background-color: #698273; }
