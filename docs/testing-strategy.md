...
Map-setup tests reopen an existing reusable map, switch between all-army and all-fleet placement previews, drag ordinary and split-coast anchors, save the edited map and verify that an existing game's private map snapshot is unchanged.
