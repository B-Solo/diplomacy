...
They cover startup recovery, confirmed game deletion, current-versus-historical editing, inline order editing, automatic clearing of `Final`, warning expansion, the unfinalised filter, adjudication confirmation, saved views and clipboard requests.
