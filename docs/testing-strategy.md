...
Renderer tests first inspect the composed SVG structure for deterministic layers, clean move-arrow joins, compact hold badges, centred multiline territory labels, positioned and rotated named-coast labels, clipped bounds and absence of forbidden hidden-state data.
