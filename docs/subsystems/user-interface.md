...
- `orders_workspace` owns one inline text editor per configured power, warning expansion, final toggles, the unfinalised-power filter and collection of pending text before an order-overlay preview.
